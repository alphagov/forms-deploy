...
# This resource contains values we need in /modules/forms-runner/main.tf
# We need the primary_endpoint_address and port elsewhere in the code
resource "aws_elasticache_replication_group" "forms-runner" {
  ...
  replication_group_description = "redis replication group for forms-runner"
