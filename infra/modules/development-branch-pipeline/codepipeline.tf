...
module "docker_build" {
  ...
  project_name                   = "${var.app_name}-docker-build-${var.environment}-branch"
  project_description            = "Build the ${var.app_name} docker image from a development branch and push into ECR"
