      ...
      and_statement {
        ...
        statement {
          regex_match_statement {
            ...
            regex_string = "^/(?:preview-draft|preview-archived|preview-live|form)/\\d+/[\\w-]+(\\.([a-zA-Z]){2})?/[a-zA-Z\\d]+$"
            text_transformation {
              priority = 1
              type     = "LOWERCASE"
            }
      ...
      and_statement {
        statement {
          regex_match_statement {
            ...
            regex_string = "^/(?:preview-draft|preview-archived|preview-live|form)/\\d+/[\\w-]+(\\.([a-zA-Z]){2})?/[a-zA-Z\\d]+(?:/\\d+)?$"
            text_transformation {
              priority = 1
              type     = "LOWERCASE"
            }
