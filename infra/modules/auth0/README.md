...
To be able to use this module, you will need the client ID and client secret of the machine to machine application in the GOV.UK Forms tenant for the environment you are terraforming. The deployment module should be configured to configure the provider with these values as sensitive variables (see [/infra/deployments/development/auth0/main.tf]() for an example).
