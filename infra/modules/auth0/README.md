...
Note that when bootstrapping you will need to create a tenant and machine to machine application following the steps in the Auth0 provider documentation [[1]].
