    ...
    input_template = <<EOF
{
  ...
  "Issues":  <issues>,
  "Next steps": {
    "1": "If you need to troubleshoot for issues with running GuardDuty Runtime Protection go to: https://docs.aws.amazon.com/guardduty/latest/ug/gdu-assess-coverage-ecs.html",
    "2": "Explore the GuardDuty Findings for Runtime Monitoring and follow the remediation recommendations: https://docs.aws.amazon.com/guardduty/latest/ug/findings-runtime-monitoring.html"}
}
EOF
  }
}
