...
variable "environment_type" {
  ...
  nullable    = false
  validation {
    condition     = contains(["development", "staging", "production", "user_research", "integration", "ithc"], var.environment_type)
    error_message = "variable 'environment_type' must be one of dev, staging, production, user_research, integration, or ithc"
  }
}
