...
module CodePipelineFixtures
  ...
  def self.list_pipelines
    @codepipeline_client_stub.stub_data(
      :list_pipelines,
      { pipelines: [{ name: 'pipeline-one', version: 6,
                      created: Time.parse('2023-01-01'), updated: Time.parse('2023-01-01') },
                    { name: 'pipeline-two', version: 7,
                      created: Time.parse('2023-01-01'), updated: Time.parse('2023-01-01') },
                    { name: 'pipeline-three', version: 3,
                      created: Time.parse('2023-01-01'), updated: Time.parse('2023-01-01') }] }
    )
  end
