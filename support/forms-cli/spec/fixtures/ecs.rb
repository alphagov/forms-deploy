      ...
      { services: [{ service_arn: 'forms-admin-service-arn',
                     ...
                     deployments: [{ id: 'deployment-id',
                                     ...
                                     network_configuration: { awsvpc_configuration: {
                                       subnets: %w[subnets], security_groups: ['security-group'], assign_public_ip: 'DISABLED'
                                     } },
                     ...
                     events: [{ id: 'id', created_at: Time.parse('2023-01-01'), message: '(service forms-admin) has reached a steady state.' },
                              { id: 'fac95ea0-316f-4fdf-a200-f2b1f31f97ac',
                                created_at: Time.parse('2023-01-02'), message: '(service forms-admin) has reached a steady state.' },
                              { id: '38c4d986-a847-47b6-b9fc-ac4b6d5b0a33',
                                created_at: Time.parse('2023-01-03'), message: '(service forms-admin) has reached a steady state.' },
                              { id: 'd5361915-43f7-4d9c-9ba1-0df2649372f2',
                                created_at: Time.parse('2023-01-04'), message: '(service forms-admin) has reached a steady state.' }],
